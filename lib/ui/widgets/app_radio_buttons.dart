...
class ReasonForCancellationRadio extends StatefulWidget {
  ...
  @override
  _ReasonForCancellationRadioState createState() => _ReasonForCancellationRadioState();
}

class _ReasonForCancellationRadioState extends State<ReasonForCancellationRadio> {
     int _radioSelected = 1;
  String? _radioVal;
  @override
  Widget build(BuildContext context) {
...
class BookingCancellationRadio extends StatefulWidget {
  ...
  @override
  _BookingCancellationRadioState createState() => _BookingCancellationRadioState();
}
